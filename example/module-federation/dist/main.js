...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["module-federation"] = factory(require("React"), require("ReactDOM"));
	else
		root["module-federation"] = factory(root["React"], root["ReactDOM"]);
...
/*!******************!*\
  ...
  \******************/
/*! namespace exports */
/*! export bootstrap [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] */
/*! export mount [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] */
/*! export unmount [provided] [maybe used in main (runtime-defined)] [usage prevents renaming] */
...
eval("module.exports = __WEBPACK_EXTERNAL_MODULE_react_dom__;\n\n//# sourceURL=webpack://module-federation/external_%22ReactDOM%22?");

/***/ }),

/***/ "webpack/container/reference/mainApp":
/*!*********************************************************************!*\
  !*** external "mainApp@http://localhost:8000/mainAppFederation.js" ***!
  \*********************************************************************/
/*! dynamic exports */
...
eval("var error = new Error();\nmodule.exports = new Promise((resolve, reject) => {\n\tif(typeof mainApp !== \"undefined\") return resolve();\n\t__webpack_require__.l(\"http://localhost:8000/mainAppFederation.js\", (event) => {\n\t\tif(typeof mainApp !== \"undefined\") return resolve();\n\t\tvar errorType = event && (event.type === 'load' ? 'missing' : event.type);\n\t\tvar realSrc = event && event.target && event.target.src;\n\t\terror.message = 'Loading script failed.\\n(' + errorType + ': ' + realSrc + ')';\n\t\terror.name = 'ScriptExternalLoadError';\n\t\terror.type = errorType;\n\t\terror.request = realSrc;\n\t\treject(error);\n\t}, \"mainApp\");\n}).then(() => mainApp);\n\n//# sourceURL=webpack://module-federation/external_%22mainApp@http://localhost:8000/mainAppFederation.js%22?");
...
/******/ 	(() => {
/******/ 		var chunkMapping = {
/******/ 			"webpack_container_remote_mainApp_Button": [
/******/ 				"webpack/container/remote/mainApp/Button"
/******/ 			]
/******/ 		};
...
/******/ 			var uniqueName = "module-federation";
...
/******/ 			switch(name) {
/******/ 				case "default": {
/******/ 					initExternal("webpack/container/reference/mainApp");
/******/ 				}
/******/ 				break;
/******/ 			}
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "//localhost:8000/module-federation/dist/";
/******/ 	})();
/******/ 	
